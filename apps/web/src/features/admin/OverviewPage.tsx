...
const zh: AdminCopy = {
  ...
  plugins: "业务插件",
  pluginsDesc: "查看已接入的业务能力、工具和所需权限。",
  prompts: "提示词覆盖",
  promptsDesc: "编辑或发布平台级提示词，覆盖插件目录中的默认内容。",
  tools: "工具与权限",
  toolsDesc: "查看工具权限矩阵，并在开启试调后验证单个工具。",
  observe: "运行与治理",
  observeIntro: "从结果、用量和事件记录判断系统是否按预期运行。",
  runs: "运行记录",
  runsDesc: "按状态查看失败运行，并打开调试详情检查完整链路。",
  usage: "Token 用量",
  usageDesc: "按租户、业务能力或模型查看已上报的用量。",
  contracts: "平台事件约定",
  contractsDesc: "查看稳定事件类型和插件扩展事件格式。",
  status: "当前状态",
  domains: "业务插件",
  runs24h: "近 24 小时运行",
  llm: "模型服务",
...
const en: AdminCopy = {
  ...
  connect: "Manage business integrations",
  connectIntro: "Review plugins, prompts, and permissions so models only use allowed capabilities.",
  plugins: "Business plugins",
  pluginsDesc: "Review connected capabilities, tools, and required permissions.",
  prompts: "Prompt overrides",
  promptsDesc: "Edit or publish platform prompts that override plugin defaults.",
  tools: "Tools and permissions",
  toolsDesc: "Review the permission matrix and test one tool when invocation is enabled.",
  observe: "Operations and governance",
  observeIntro: "Use results, usage, and event records to confirm the system behaves as expected.",
  runs: "Run records",
  ...
  contracts: "Platform event rules",
  contractsDesc: "Review stable event types and plugin extension formats.",
  status: "Current status",
  domains: "Business plugins",
...
export function OverviewPage() {
  ...
  return <main className="page admin-hub">
    ...
    <AdminSection title={copy.observe} intro={copy.observeIntro} links={[
      ...
      { to: "/contracts", title: copy.contracts, description: copy.contractsDesc },
    ]} />
